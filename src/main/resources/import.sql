...
insert into customer (id, full_name, email, password, cep, address_number, complement) values ('c8dadecb-bbd3-4e9d-b49a-141922f3a673', 'Clyde Stanley', 'mavku@mojje.eg', 'JtdRWqT129', '35505-531', 23, 'House');
insert into customer (id, full_name, email, password, cep, address_number, complement) values ('08862b4d-aff7-4867-84df-94b35bdf1c98', 'Edwin Edwards', 'zemzaf@ahu.ck', 'LHNG46IzsCg500P', '75223-713', 120, 'Apartment');
insert into customer (id, full_name, email, password, cep, address_number, complement) values ('5d9c0196-0c94-4953-b10a-bb736052e23c', 'Dean Glover', 'pik@ruce.kz', 'vHw7jL', '43939-394', 863, 'House');
insert into customer (id, full_name, email, password, cep, address_number, complement) values ('61f3ecc8-9252-4a9e-9798-54c9b72e4e62', 'James Sullivan', 'va@zatpuspof.jo', 'uQPwkSqMzXID773R9U', '83285-762', 15, 'Apartment');
